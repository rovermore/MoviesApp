...
class MainViewModel
@Inject constructor(private val getPopularMoviesUseCaseUseCase: GetPopularMoviesUseCase) : ViewModel() {
    ...
    private fun observeResponse() {
        viewModelScope.launch {
            try {
                val popularMovies = getPopularMoviesUseCaseUseCase.request()
